...
export class MobilityStudentsPracticePageService extends ApiService {
    ...
    update(page: IMobilityStudentsPracticePage): Observable<IMobilityStudentsPracticePage> {
        return this.putInternal<IMobilityStudentsPracticePage>(`${MOBILITY_STUDENTS_PRACTICE_PAGE_API}`, {
